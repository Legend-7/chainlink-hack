...
function buildInventory(user) {
    ...
    contentContainer.innerHTML = buildInventoryComponent(user);
  ...
  function buildInventoryComponent(user) {
    return `
  ...
  <div class="products-area-wrapper tableView">
    ...
    <div class="products-row">
      <button class="cell-more-button">
        ...
        <div class="product-cell image">
          <img src="https://source.unsplash.com/random/sky" alt="product">
          <span>Name</span>
        </div>
      <div class="product-cell category"><span class="cell-label">Category:</span>Category 1</div>
